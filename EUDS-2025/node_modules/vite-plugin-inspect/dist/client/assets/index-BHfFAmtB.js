...
const routes = [
  {
    path: "/",
    name: "/",
    component: () => __vitePreload(() => import('./index-1UGaR1Tl.js'),true?__vite__mapDeps([0,1,2,3,4,5]):void 0,import.meta.url),
    children: [
      {
        path: ":all(.*)",
        name: "//[...all]",
        component: () => __vitePreload(() => import('./_...all_-44abFvWP.js'),true?__vite__mapDeps([6,2]):void 0,import.meta.url)
        /* no children */
      },
      {
        path: "metric",
        name: "//metric",
        component: () => __vitePreload(() => import('./metric-D8K24XYq.js'),true?__vite__mapDeps([7,1,2,4,5,8]):void 0,import.meta.url)
        /* no children */
      },
      {
        path: "module",
        name: "//module",
        component: () => __vitePreload(() => import('./module-CGIrpUO3.js'),true?__vite__mapDeps([9,1,2,4,3,8,10]):void 0,import.meta.url)
        /* no children */
      },
      {
        path: "plugins",
        name: "//plugins",
        component: () => __vitePreload(() => import('./plugins-l0WIef6e.js'),true?__vite__mapDeps([11,1,2]):void 0,import.meta.url)
        /* no children */
      }
    ]
  }
...
function createStaticRpcClient() {
  async function getModuleTransformInfo(query, id) {
    const { hash } = await __vitePreload(async () => { const { hash } = await import('./index-CPVdrAhL.js');return { hash }},true?[]:void 0,import.meta.url);
